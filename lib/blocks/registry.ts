...
export const BLOCKS: BlockDef[] = [
  {
    ...
    fields: [
      ...
      rich("photoNote", "Photo note (editor only — never shown on the live site)", RICH_HELP),
    ],
  ...
  },
  {
    ...
    fields: [
      txt("eyebrow", "Eyebrow"), area("title", "Title"), area("lead", "Lead"),
      { key: "steps", label: "Steps", type: "items", itemLabel: "step", fields: [txt("num", "Number"), txt("title", "Title"), area("text", "Text"), { key: "image", label: "Step image (optional)", type: "image" }, txt("imageAlt", "Image alt text")] },
      cta("cta", "Button"),
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "flip", label: "Flip cards (image front, text on hover)", type: "boolean", help: "Only cards with an image flip." },
